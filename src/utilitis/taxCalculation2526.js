...
const taxCalculation = (taxPayer, taxArea, taxableIncome) => {
    ...
    if (taxPayer === 350000) {
        ...
        if (taxableIncome > slab1 && taxableIncome <= slab2) {
            ...
            let stap1 = 100000 * 0.05;
            let stap2 = 400000 * 0.10;
            let stap3 = (taxableIncome - slab3) * 0.15;
            ...
            let stap1 = 100000 * 0.05;
            let stap2 = 400000 * 0.10;
            let stap3 = 500000 * 0.15;
            let stap4 = (taxableIncome - slab4) * 0.20;
